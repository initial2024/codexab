...
export default function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    version: "selfhost-base-v2-file-parse",
    ...
    costNotice: {
      ...
      fileParse:
        "文件解析不会请求 AI 模型，但会消耗云端函数调用、带宽和运行时间。大文件可能触发平台限制。",
    },

    warning:
      "This is a self-hosted backend. Diagnostics are only for configuration checking and do not guarantee all websites, files, models, or upstream providers will work.",
  });
}
